...
public class scenario2 {public WebDriver driver;
...
public void beforeTest(String browser) {
	System.out.println("tests to validate instawork website does nt  appear first in google search the test should find out on which position on the list it appears in search results");
      	...
      	while (itr.hasNext()) {
                ...
                //  String title = element.getText();
                 ...
                 // System.out.println(title);
      	        if (element.getAttribute("href").contains(matchInUrl)) {
...
@Test(priority=2 ,description="Click on login button of instawork ")
  ...
  public void Login() throws InterruptedException{
	driver.findElement(By.className("_l8p4s")).click();
